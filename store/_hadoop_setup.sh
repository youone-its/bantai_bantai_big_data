...
docker exec -it hadoop-namenode hdfs dfs -mkdir -p /data/opendata-sby/penduduk-usia
docker exec -it hadoop-namenode hdfs dfs -mkdir -p /data/opendata-sby/sekolah-akreditasi
docker exec -it hadoop-namenode hdfs dfs -mkdir -p /data/opendata-sby/sekolah-negeri-swasta
docker exec -it hadoop-namenode hdfs dfs -mkdir -p /data/opendata-sby/siswa-negeri-swasta
docker exec -it hadoop-namenode hdfs dfs -mkdir -p /data/opendata-sby/sd-akreditasi-kecamatan
docker exec -it hadoop-namenode hdfs dfs -mkdir -p /data/opendata-sby/smp-akreditasi-kecamatan
docker exec -it hadoop-namenode hdfs dfs -mkdir -p /data/opendata-sby/sekolah-murid-guru-rasio
